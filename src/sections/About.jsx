...
function About() {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("kgostudio571@gmail.com");
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        }, 2000);
    ...
    <section className="c-space my-20" id="about" >
        <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                ...
                <div className="grid-container">
                    ...
                    <div>
                        <p className="grid-headtext">
                            I work remotley across most tomezones.
                        </p>
            ...
            <div className="xl:col-span-1 xl:row-span-2">
                <div className="grid-container">
                    <img src="/assets/grid4.png" alt="grid-4" className="w-full md:h-[126px] sm:h-[256px] h-fit object-cover sm:object-top"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="copy-container" onClick={handleCopy}>
                            ...
                            <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white ">kgostudio571@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
